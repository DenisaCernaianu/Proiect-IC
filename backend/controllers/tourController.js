...
export const createTour = async(req,res)=>{
    ...
    try{
       ...
       res.status(200).json({success:true, message:'Successfully created',data:savedTour});
        ...
        res.status(500).json({success:false, message:'Failed to be  created.Try again!'});
...
export const updateTour = async(req,res)=>{
    ...
    try {
        ...
        res.status(500).json({success:false, message:'Failed to be updated.Try again!'});
    }
};
...
export const getTourBySearch = async(req,res)=>{
    ...
    try {
        ...
        res.status(200).json({
            success:true,  message:'Successfully found',data:tours,
        })
